    ...
    <div>
        ...
        <form action="" method="post" class="m-1">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" value="<?= esc($person->getNachname()) ?>" placeholder="Mustermann" name="INPUT_NACHNAME" size=15 class="form-control" required><br>
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon3">E-Mail</span>
                <input type="text" value="<?= esc($person->getEmail()) ?>" placeholder="beispiel" name="INPUT_EMAIL" size=15 class="form-control" required><br>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" value="<?= esc($person->getGeburtstag()) ?>" placeholder="Stuff" name="INPUTDATE_BIRTHDATE" size=15 class="form-control"><br>
            </div>
