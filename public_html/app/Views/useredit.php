...
<body>
    ...
    <?php if (isset($info)): ?>
        <div class="alert alert-primary d-flex align-items-center" role="alert">
            ...
            <div>
                <strong>Benutzer bearbeitet!</strong>&nbsp;<?= esc($info); ?>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if (isset($success)): ?>
        <div class="alert alert-success alert-dismissible fade show d-flex align-items-center" role="alert">
            ...
            <strong>Benutzer bearbeitet!</strong>&nbsp;<?= esc($success); ?>
                ...
                <form action="" method="post" class="row g-3">
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            <input type="text" value="<?= esc($person->getVorname()) ?>" name="INPUT_VORNAME" size="15" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            <input type="text" value="<?= esc($person->getNachname()) ?>" name="INPUT_NACHNAME" size="15" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            <input type="text" value="<?= esc($person->getEmail()) ?>" name="INPUT_EMAIL" size="15" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="password" placeholder="*unverändert*" name="INPUT_PASSWORD" size="15" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="date" value="<?= esc($person->getGeburtstag()) ?>" name="INPUTDATE_BIRTHDATE" size="15" class="form-control">
                        </div>
                    </div>
