        ...
        <div class="menu">
            <form action="/submit" method="post">
                <ul>
                    ...
                    <li class="menu-item hidden"><input type="submit" value="Admin" name="BUTTON_Admin" /></a></li>
                    <li class="menu-item hidden"><input type="submit" value="Buchungen" name="BUTTON_Reservation" />
                    </li>
